...
namespace HXD.MS.Entity.DAL
{
	...
	public partial class RoleDAL
	{
		...
		public int GetMaxId()
		{
		return MssqlHelper.GetMaxID("Id", "Auth_Role"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from Auth_Role");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Auth_Role(");
			strSql.Append("Name,CreateTime,Creater,Remark)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Auth_Role set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Auth_Role ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		public Role GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Name,CreateTime,Creater,Remark from Auth_Role ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Name,CreateTime,Creater,Remark ");
			strSql.Append(" FROM Auth_Role ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Name,CreateTime,Creater,Remark ");
			strSql.Append(" FROM Auth_Role ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Auth_Role T ");
