...
namespace HXD.MS.BLL
{
    ...
    public partial class UserRoleService
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(HXD.MS.Entity.UserRole model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(HXD.MS.Entity.UserRole model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public HXD.MS.Entity.UserRole GetModel(int Id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<HXD.MS.Entity.UserRole> GetModelList(string strWhere)
        {
        ...
        {
            return dal.SaveUserRole(userId, roleIds);
        }
        public string GetRolesByUserId(int userId)
        {
            StringBuilder sb = new StringBuilder();
            DataTable dataTable = dal.GetRolesByUserId(userId);
            foreach (DataRow dr in dataTable.Rows)
            {
                sb.Append(dr["RoleId"].ToString() + ",");
            }
